...
function StatinoInformation({ sta }: NextStaionProps){
    ...
    return (
        ...
        <div className='w-full'>
            ...
            { 
              isMultipeLines && 
              <select className="border border-gray-300 text-sm rounded-lg w-full p-2.5 focus:ring-blue-500 focus:border-blue-500" onChange={(e) => checkEstimateTime(e.target.value, sta).then(setArrivalData)}>
